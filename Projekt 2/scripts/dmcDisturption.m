...
hold off
xlabel('k');
legend('y', 'yZad', 'disturption')
saveas(f, sprintf('./zaklocenie/Wyjscie_D=%d_N=%d_Nu=%d_zaklocenie=%d.jpg', D, N, Nu, disturption(k)));
close(f);
...
xlabel('k');
legend('u')
saveas(f, sprintf('./zaklocenie/Sterowanie_D=%d_N=%d_Nu=%d_zaklocenie=%d.jpg', D, N, Nu, disturption(k)));
close(f);
