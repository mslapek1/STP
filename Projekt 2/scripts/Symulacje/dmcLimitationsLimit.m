...
xlabel('k');
legend('y', 'yZad')
saveas(f, sprintf('./limitations/L_wyjscie_D=%d_N=%d_Nu=%d_ograniczeniedu=%d.jpg', D, N, Nu, limit));
close(f);
...
xlabel('k');
legend('u')
saveas(f, sprintf('./limitations/L_Sterowanie_D=%d_N=%d_Nu=%d_ograniczeniedu=%d.jpg', D, N, Nu, limit));
close(f);
